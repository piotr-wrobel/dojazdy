...
setcookie("doJazdy_c1", '1234567890', time()+180,'','',true);
?>
<html>
	<head>
		<title>doJazdy v<?php echo VERSION;?></title>
	...
	<body onload="start()">
		<div id="main" class="main">
			<div id="menu_g" class="menu_g"><img src="opona.jpg" class="opona"><p class="tytul">doJazdy <span style="font-size: 10px;">v<?php echo VERSION;?></span></p><p style="text-align:right;font-size: 10px;margin:10px;">code by (-)pvg</p></div>
